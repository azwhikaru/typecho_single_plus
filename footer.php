    ...
    <div class="wrap min">
                    ...
                    <div class="col-m-4">
                        ...
                        <ul>
                            ...
                            <?php while ($comments->next()) : ?>
                                <li>
                                    <?php $comments->author(false); ?>: <a href="<?php $comments->permalink(); ?>" rel="nofollow" target="_blank">
        ...
        <section class="sub-footer">
            <p>©
                ...
                </a>. All Rights Reserved. Theme By <a href="https://github.com/Dreamer-Paul/Single" target="_blank" rel="nofollow">Single</a> and <a href="https://github.com/azwhikaru" target="_blank" rel="nofollow">Ayabe</a>.
            </p>
            ...
            <?php if ($this->options->show_uptime) : ?>
                <p><?php
                    ...
                    ?></p>
            <?php endif; ?>
            <?php if ($this->options->show_loading_timer) : ?>
            <?php if ( function_exists('timer_stop') ) { ?>
            <p><?php
            $timer_stop = timer_stop(0);
            echo sprintf($this->options->custom_loading_timer ? $this->options->custom_loading_timer : "载入本页面耗时 %s 秒", $timer_stop);
            ?></p>
            <?php } ?>
            <?php endif; ?>
            <?php if ($this->options->show_loading_timer) : ?>
            ...
            <p><?php
            $sql_count = $GLOBALS['num_queries'];
            echo sprintf($this->options->custom_sql_count ? $this->options->custom_sql_count : "载入本页面运行了 %s 次 SQL", $sql_count);
            ?></p>
            <?php } ?>
            <?php endif; ?>
        </section>
