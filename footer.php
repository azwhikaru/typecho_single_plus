    ...
    <div class="wrap min">
                    ...
                    <div class="col-m-4">
                        ...
                        <ul>
                            ...
                            <?php while ($comments->next()): ?>
                                <li>
                                    <?php $comments->author(false); ?>: <a href="<?php $comments->permalink(); ?>"
        ...
        <section class="sub-footer">
            <p>©
                ...
                </a>. All Rights Reserved. Theme By <a href="https://github.com/Dreamer-Paul/Single" target="_blank"
                    rel="nofollow">Single</a> and <a href="https://github.com/azwhikaru" target="_blank"
                    rel="nofollow">Ayabe</a>.
            </p>
